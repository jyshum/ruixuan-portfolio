...
export const school: Wall = {
  ...
  tiles: [
    { src: "/school-21.jpg", piece: 0, x: 85, y: 44, w: 760, h: 1018, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-4.jpg", piece: 1, x: 815, y: 1082, w: 850, h: 701, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-9.jpg", piece: 1, x: 85, y: 1082, w: 685, h: 923, crop: [0.0, 0.0, 1.0, 0.992], delay: 0 },
    { src: "/school-7.jpg", piece: 1, x: 800, y: 1863, w: 768, h: 577, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-3.jpg", piece: 1, x: 85, y: 2033, w: 681, h: 488, crop: [0.0, 0.219, 1.0, 0.745], delay: 90 },
    { src: "/school-2.jpg", piece: 1, x: 1012, y: 2556, w: 493, h: 656, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-5.jpg", piece: 1, x: 85, y: 2556, w: 896, h: 656, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-32.jpg", piece: 1, x: 85, y: 3246, w: 1150, h: 634, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-33.jpg", piece: 1, x: 844, y: 3911, w: 681, h: 738, crop: [0.233, 0.0, 0.752, 1.0], delay: 0 },
    { src: "/school-31.jpg", piece: 1, x: 85, y: 3911, w: 739, h: 868, crop: [0.257, 0.0, 0.732, 1.0], delay: 90 },
    { src: "/school-10.jpg", piece: 2, x: 85, y: 4853, w: 570, h: 434, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-22.jpg", piece: 2, x: 979, y: 4989, w: 518, h: 691, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-6.jpg", piece: 2, x: 85, y: 5308, w: 862, h: 648, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-11.jpg", piece: 2, x: 674, y: 5971, w: 790, h: 592, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-23.jpg", piece: 2, x: 85, y: 5971, w: 558, h: 746, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-34.jpg", piece: 2, x: 85, y: 6740, w: 837, h: 1119, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-17.jpg", piece: 3, x: 841, y: 7907, w: 747, h: 562, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-18.jpg", piece: 3, x: 85, y: 7908, w: 735, h: 561, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-19.jpg", piece: 3, x: 840, y: 8488, w: 748, h: 562, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-20.jpg", piece: 3, x: 85, y: 8488, w: 735, h: 562, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-12.jpg", piece: 4, x: 85, y: 9090, w: 628, h: 484, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-14.jpg", piece: 4, x: 739, y: 9494, w: 391, h: 574, crop: [0.0, 0.0, 0.911, 1.0], delay: 90 },
    { src: "/school-13.jpg", piece: 4, x: 85, y: 9586, w: 631, h: 482, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-16.jpg", piece: 4, x: 981, y: 10089, w: 629, h: 838, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-15.jpg", piece: 4, x: 85, y: 10089, w: 868, h: 1180, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-28.jpg", piece: 5, x: 1021, y: 11495, w: 394, h: 704, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-30.jpg", piece: 5, x: 85, y: 11495, w: 936, h: 704, crop: [0.0, 0.011, 1.0, 1.0], delay: 90 },
    { src: "/school-25.jpg", piece: 6, x: 593, y: 12226, w: 1076, h: 807, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-24.jpg", piece: 6, x: 85, y: 12382, w: 476, h: 651, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-26.jpg", piece: 7, x: 1080, y: 13089, w: 494, h: 371, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-27.jpg", piece: 7, x: 588, y: 13090, w: 466, h: 370, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-29.jpg", piece: 7, x: 85, y: 13090, w: 482, h: 370, crop: [0.0, 0.0, 1.0, 1.0], delay: 180 },
  ],
  labels: [
    { text: "2025-2026", x: 1196, y: 1020, w: 300, h: 47 },
    { text: "2024-2025", x: 1030, y: 11282, w: 466, h: 73 },
  ],
  gaps: [],
};
