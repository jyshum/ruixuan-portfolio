...
export const club: Wall = {
  ...
  labels: [
    { text: "2024-2025", x: 463, y: 8556, w: 300, h: 47 },
  ],
  gaps: [],
};
...
export const school: Wall = {
  ...
  tiles: [
    ...
    { src: "/school-4.jpg", piece: 1, x: 643, y: 1104, w: 957, h: 789, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-9.jpg", piece: 1, x: 915, y: 1915, w: 685, h: 923, crop: [0.0, 0.0, 1.0, 0.992], delay: 0 },
    { src: "/school-7.jpg", piece: 1, x: 117, y: 2696, w: 768, h: 577, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-3.jpg", piece: 1, x: 919, y: 2866, w: 681, h: 488, crop: [0.0, 0.219, 1.0, 0.745], delay: 90 },
    { src: "/school-2.jpg", piece: 1, x: 180, y: 3389, w: 493, h: 656, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-5.jpg", piece: 1, x: 704, y: 3389, w: 896, h: 656, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-32.jpg", piece: 1, x: 450, y: 4079, w: 1150, h: 634, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-33.jpg", piece: 1, x: 160, y: 4744, w: 681, h: 738, crop: [0.233, 0.0, 0.752, 1.0], delay: 0 },
    { src: "/school-31.jpg", piece: 1, x: 861, y: 4744, w: 739, h: 868, crop: [0.257, 0.0, 0.732, 1.0], delay: 90 },
    { src: "/school-10.jpg", piece: 2, x: 1030, y: 5686, w: 570, h: 434, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-22.jpg", piece: 2, x: 188, y: 5822, w: 518, h: 691, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-6.jpg", piece: 2, x: 738, y: 6141, w: 862, h: 648, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-11.jpg", piece: 2, x: 221, y: 6804, w: 790, h: 592, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-23.jpg", piece: 2, x: 1042, y: 6804, w: 558, h: 746, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-34.jpg", piece: 2, x: 763, y: 7573, w: 837, h: 1119, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-17.jpg", piece: 3, x: 97, y: 8740, w: 747, h: 562, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-18.jpg", piece: 3, x: 865, y: 8741, w: 735, h: 561, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-19.jpg", piece: 3, x: 97, y: 9321, w: 748, h: 562, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-20.jpg", piece: 3, x: 865, y: 9321, w: 735, h: 562, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-12.jpg", piece: 4, x: 972, y: 9923, w: 628, h: 484, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-14.jpg", piece: 4, x: 555, y: 10327, w: 391, h: 574, crop: [0.0, 0.0, 0.911, 1.0], delay: 90 },
    { src: "/school-13.jpg", piece: 4, x: 969, y: 10419, w: 631, h: 482, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-16.jpg", piece: 4, x: 75, y: 10922, w: 629, h: 838, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-15.jpg", piece: 4, x: 732, y: 10922, w: 868, h: 1180, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-28.jpg", piece: 5, x: 270, y: 12328, w: 394, h: 704, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-30.jpg", piece: 5, x: 664, y: 12328, w: 936, h: 704, crop: [0.0, 0.011, 1.0, 1.0], delay: 90 },
    { src: "/school-25.jpg", piece: 6, x: 16, y: 13059, w: 1076, h: 807, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-24.jpg", piece: 6, x: 1124, y: 13215, w: 476, h: 651, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-26.jpg", piece: 7, x: 111, y: 13922, w: 494, h: 371, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/school-27.jpg", piece: 7, x: 631, y: 13923, w: 466, h: 370, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/school-29.jpg", piece: 7, x: 1118, y: 13923, w: 482, h: 370, crop: [0.0, 0.0, 1.0, 1.0], delay: 180 },
  ],
  labels: [
    { text: "2025-2026", x: 189, y: 30, w: 300, h: 47 },
    { text: "2024-2025", x: 158, y: 12115, w: 466, h: 73 },
  ],
  gaps: [],
};
...
export const asiaCourse: Wall = {
  ...
  tiles: [
    { src: "/asia-course-6.jpg", piece: 0, x: 103, y: 0, w: 1305, h: 1172, crop: [0.034, 0.118, 0.883, 0.881], delay: 0 },
    { src: "/asia-course-10.png", piece: 1, x: 180, y: 1398, w: 1075, h: 606, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/asia-course-11.jpg", piece: 1, x: 1284, y: 1398, w: 316, h: 606, crop: [0.371, 0.0, 0.652, 1.0], delay: 90 },
    { src: "/asia-course-5.jpg", piece: 2, x: 35, y: 2066, w: 1565, h: 873, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/asia-course-4.jpg", piece: 4, x: 439, y: 3001, w: 397, h: 703, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/asia-course-1.jpg", piece: 3, x: 910, y: 3001, w: 690, h: 483, crop: [0.0, 0.365, 0.965, 0.882], delay: 90 },
    { src: "/asia-course-12.jpg", piece: 4, x: 876, y: 3511, w: 724, h: 651, crop: [0.212, 0.059, 0.774, 0.973], delay: 90 },
    { src: "/asia-course-14.jpg", piece: 4, x: 191, y: 3724, w: 645, h: 650, crop: [0.216, 0.0, 0.775, 1.0], delay: 90 },
    { src: "/asia-course-13.jpg", piece: 4, x: 876, y: 4200, w: 724, h: 398, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/asia-course-3.jpg", piece: 5, x: 227, y: 4631, w: 662, h: 881, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/asia-course-2.jpg", piece: 5, x: 924, y: 4631, w: 676, h: 881, crop: [0.0, 0.0, 1.0, 1.0], delay: 90 },
    { src: "/asia-course-7.jpg", piece: 6, x: 658, y: 5582, w: 942, h: 697, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/asia-course-8.jpg", piece: 7, x: 354, y: 6314, w: 1246, h: 923, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
    { src: "/asia-course-9.jpg", piece: 7, x: 354, y: 7291, w: 1246, h: 965, crop: [0.0, 0.0, 1.0, 1.0], delay: 0 },
  ],
  labels: [
    { text: "Summer 2025", x: 180, y: 1221, w: 389, h: 47 },
  ],
  gaps: [
  ],
};
